...
class BaseAthenaBucket(s3.Bucket):
    ...
    def __init__(self, scope: core.Construct, deploy_env: Environment, **kwargs) -> None:
        ...
        self.obj_name = f's3-bck-{self.deploy_env.value}-data-lake-athena-results'
...
class BaseAthenaWorkgroup(athena.CfnWorkGroup):
    ...
    def __init__(self, scope: core.Construct, deploy_env: Environment,
        ...
        self.obj_name = f's3-bck-{self.deploy_env.value}-data-lake-athena-workgroup'
        super().__init__(
            scope,
            id=self.obj_name,
            name=self.obj_name,
    ...
    def bytes_scanned_cutoff_per_query(self):
        return self.gb_scanned_cutoff_per_query * 1000000000  # Quero cortar depois de 1Gb